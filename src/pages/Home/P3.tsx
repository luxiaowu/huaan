            ...
            if (chart) {
                ...
                chart.on('finished', function() {
                    ...
                    centerText.forEach((textItem: any, index: number) => {
                        ...
                        chart.getZr().add(new echarts.graphic.Text({
                            style: {
                                ...textStyle,
                                text: textItem.text
                            },
    ...
    return (
        <Block className="p-0" title={
            <div className="flex items-center gap-2">
                ...
                <div className="text-white text-[18px] font-bold">县域产业</div>
            </div>
        } >
                ...
                <div className="grid grid-cols-3 gap-0 mt-4">
                    {[
                        ...
                        <div key={index} className="flex flex-col items-center p-2">
                            ...
                            <div className="text-[#00E4FF] text-[20px] font-bold">{item.value}%</div>
                        </div>
                    ))}
                </div>
            </div>
